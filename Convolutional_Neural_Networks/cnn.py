...
print('\n Make single predictions: dataset/test_set/cats/cat.4001.jpg')
test_image = image.load_img('dataset/test_set/cats/cat.4001.jpg', target_size = (256, 256))
...
# loss: 0.1028 - acc: 0.9623 - val_loss: 0.4677 - val_acc: 0.8550
